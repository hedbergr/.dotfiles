...
(custom-set-variables
 ...
 '(package-selected-packages
   '(company-jedi elpy yasnippet flycheck smex git-gutter+ git-gutter-fringe+ expand-region visual-regexp auto-complete ace-window avy hc-zenburn-theme use-package cmake-mode)))
(custom-set-faces
